...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[width=1\textwidth]{gfx/5.png}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[width=\textwidth]{gfx/5_sequence.png}
...
\begin{figure}[htp]
	\begin{center}
		\includegraphics[width=1\textwidth]{gfx/9_component.png}
